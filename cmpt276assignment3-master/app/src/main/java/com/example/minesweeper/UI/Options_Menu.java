...
public class Options_Menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button returnButton = (Button) findViewById(R.id.returnSettingsButton);
    ...
    private void createBoardSize() {
        RadioGroup BoardSpecs = findViewById(R.id.radio_board_specs);
        ...
        for(int i =0; i < RowSpecs.length; i++) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(Options_Menu.this,"You selected "+ numRow+" rows by "+ numCol+" columns",Toast.LENGTH_SHORT).show();
    ...
    private void createMineSize() {
        RadioGroup group = (RadioGroup) findViewById(R.id.radio_group_mine_size);
        ...
        for (int i =0; i< numMines.length;i++)
        {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(Options_Menu.this,"You selected "+ numMine,Toast.LENGTH_SHORT)
                            .show();
    ...
    public static Intent makeLaunchIntent(Context c){
        Intent intent = new Intent(c, Options_Menu.class);
        return intent;
    }
}